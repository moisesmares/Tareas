...
public class VentanaLibro extends JFrame {
    ...
    private JPanel panel2; // Tabla para Libros
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(240, 137, 137));
        lblId = new JLabel("Id:");
        ...
        panel2.setBackground(new Color(137, 240, 204));
        ...
        panel3.setBackground(new Color(166, 112, 241));
        //Panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(149, 144, 144));
